...
<body>
    ...
    <div class="invoice-details">
        <p><strong>Cash Memo No:</strong> {{$invoice_number}}</p>
        <p><strong>Cash Memo To:</strong> {{$clientName}}, {{$clientAddress}}</p>
...
<div class="total-section text-end">
    <p><strong>GRAND TOTAL:</strong> {{ number_format($services['sub_total'] ?? 0, 2) }}</p>
</div>
