    ...
    <div class="page">
        @foreach($page as $jobCard)
            ...
            <div class="certificate-small">
                ...
                $item=$jobCard->itemss->item_name;
                $conc=$jobCard->conc1;


                $finals = $desc . ' ' . $item . ', Weighing in total ' . $jobCard->grwt . ' g. Studded With ' .$conc;
                ...
                @endphp
                        ...
                        <h2 class="text-center">Gem Stone Jewellery Job Card</h2>
                <p><span class="bold">SUMMARY NO:</span> <span class="highlight">{{ $jobCard->jobcardid }}</span></p>
                    ...
                    <p><span class="bold">Conclusion:</span> {{ $conc }}</p>
                    <p><span class="bold">Comments:</span>Grading and Analyis as mounting permits</p>
