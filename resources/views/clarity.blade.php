                ...
                <div class="card">
                  <div class="card-body">
                      <div class="d-flex justify-content-between"> 
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal" data-ds-name="#" data-ds-cid="#"  data-bs-target="#addNewService"> Add Clarity</button>
                      </div>
                    ...
                    <div id="clientTabl">
                    @include('partials.Clarity_table')
                  </div>
