                 ...
                 <td><label class="badge badge-gradient-warning"><a href="javascript:void(0);" 
                   ...
                   <td>
                    ...
                    <form id="delete-form" method="POST" style="display: none;">
                        ...
                        <a href="javascript:void(0);" onclick="confirmDelete('{{ route('metals.destroy', $client->metal_id) }}')" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="coBrandingForm" action="{{ route('metals.store') }}" method="POST" >
                @csrf
                   

                   
                    <div class="mb-3">
                        <label for="coBrandingText" class="form-label">Enter Metal Name</label>
                        <input type="text" class="form-control" name="metal_name" id="metal_name" required placeholder="Enter Metal Name">
                     
                       
                    </div>

                    <div class="mb-3">
                        <label for="coBrandingText" class="form-label">Enter Metal Code</label>
                        <input type="text" class="form-control" name="code" id="code" required placeholder="Enter Metal code">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="coBrandingForm" action="{{ route('metals.updateDetails') }}" method="POST">
                @csrf
                    ...
                    <div class="mb-3">
                        <label for="coBrandingText" class="form-label">Enter Metal Name</label>
                        <input type="text" class="form-control"  name="metal_names" required id="metal_names" required placeholder="Enter Name">
                        <input type="hidden" class="form-control" name="metal_id" readonly id="metal_id" placeholder="Enter Co-branding Name">
                    </div>
        ...
        $('#coBrandingModal').on('show.bs.modal', function (event) {
            ...
            $('#clientNameDisplay').text(clientName); // If displaying in a <span>
             ...
             document.getElementById('editRateCard').addEventListener('show.bs.modal', function(event) {
                ...
                let metal_id  = button.getAttribute('data-metal_id'); 
                let metal_name = button.getAttribute('data-metal_name'); 
                let code = button.getAttribute('data-code'); 
              
              
                console.log(code);

                $('#metal_id').val(metal_id);
                $('#metal_names').val(metal_name);
                $('#codes').val(code);
