    ...
    <table class="table">
        ...
        @else   
            ...
            <tr>
                ...
                <td>
                                <input type="file" class="form-control w-50" name="images[{{ $client->jobcard_id}}]" accept="image/*" required />
                                @if($client->image)
                                    <br>
                ...
                <a href="javascript:void(0);" data-bs-toggle="modal" data-id={{$client->jobcard_id}}
                    ...
                    data-cut={{$client->cut}}   
                    data-conc={{$client->conc}}   
                    data-conc1={{$client->conc1}}   
                ...
                <td>
                    <label class="badge badge-gradient-danger">
                        ...
                        onclick="confirmDelete('{{ route('gem_jewelery_job_card_delete', $client->jobcard_id ) }}')" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="coBrandingModalLabel">Edit  Gems Jewelery Job Card</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="updatejobcard_dimond" method="POST" action="{{route('update_gems_jewelery_card')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        <label for="confno" class="form-label">Conclusion   :</label>
                        <input type="text" class="form-control " id="conc" name="conc"  required placeholder="Enter Service Name">
                    </div>

                    <div class="mb-3">
                        <label for="confno" class="form-label">Conclusion -1   :</label>
                        <input type="text" class="form-control " id="conc1" name="conc1"  required placeholder="Enter Service Name">
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let url = "{{ route('print_gems_jewelery_certificates') }}?ids=" + selectedIds.join(',');
