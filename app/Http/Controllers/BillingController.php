...
class BillingController extends Controller
{
    ...
    public function getReport($id){
        ...
        $diamond_jobs_service_total_amount = $diamond_jobs_service_total_amount ?? 0;
        $gemstone_jobs_service_total_amount = $gemstone_jobs_service_total_amount ?? 0;
        $diamonds_jobs_service_total_amount = $diamonds_jobs_service_total_amount ?? 0;
        $gem_jewellery_card_jobs_total = $gem_jewellery_card_jobs_total ?? 0;
        $uncut_jewellery_card_total = $uncut_jewellery_card_total ?? 0;
    ...
    public function CashMemo($id){

        // creating Invoice No
        $year = Carbon::now()->year;
        $financialYear = substr($year, -2) . '-' . substr($year + 1, -2);
        
        $invoice_number="CSH/".$financialYear."/".$id;
        ...
        $pdf = PDF::loadView('cashMemoPrint', [
            'services' => $array_of_all_services,
            'invoice_number' => $invoice_number,
            'clientName' => $clientName,
            'clientAddress' => $clientAddress,
